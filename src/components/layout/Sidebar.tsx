...
import { Home, LayoutGrid, Sprout, Cloud, CalendarDays, ClipboardList, Settings, X, Apple, BookOpen, Scale, Wallet, Wheat, Beaker, Bug, UtensilsCrossed } from "lucide-react";
